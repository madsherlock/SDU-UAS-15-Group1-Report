...
distribution of this color in RGB, HSV and YCbCr spaces.  These training pathches has been exposed to either Normal uniform illumination, daylight illumination (outdoors) or flashlight illumination (under dark conditions). These training patches has been cropped such that their skin is only visible, and been analyzed on. 
