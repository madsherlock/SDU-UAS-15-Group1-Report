...
\todo[inline,author=Mikael]{We should seriously consider removing the "Report" part or stating our work contribution in other terms than section numbers and names! Because I have been through all sections to some degree and I do not like it if one person gets full credit for something others have contributed to. Either we go into full detail, or we don't go into section-level detail. Instead, we should focus on what we've actually done with respect to the project. Not the report.}
\textbf{Mathias}:\\
...
Image processing algorithm, implemententing and designing it.
